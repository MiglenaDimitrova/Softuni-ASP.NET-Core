...
namespace MyRecipes.Data.Migrations
{
    ...
    [Migration("20210714050448_AddRecipesAndRelatedModels")]
    partial class AddRecipesAndRelatedModels
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyRecipes.Data.Models.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("MyRecipes.Data.Models.Image", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("MyRecipes.Data.Models.Setting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MyRecipes.Data.Models.ApplicationUser", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("MyRecipes.Data.Models.Image", b =>
                {
                    b.HasOne("MyRecipes.Data.Models.ApplicationUser", "AddedByUser")
                        .WithMany()
